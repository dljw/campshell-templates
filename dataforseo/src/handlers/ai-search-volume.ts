// Handler: Get AI platform search volume for keywords via DataForSEO AI Keyword Data
...
interface AiSearchVolumeInput {
  keywords: string[];
  locationCode?: number;
  languageCode?: string;
}

export default async function aiSearchVolume(
  input: AiSearchVolumeInput,
