...
import type { SecretsStatusResponse } from "../hooks/useApifyYouTube.js";
    ...
    <div className="max-w-2xl mx-auto py-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add your Apify API token to enable YouTube scraping operations.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {saveSuccess && (
            <div className="bg-green-500/10 text-green-700 border border-green-200 p-4 rounded-md text-sm font-medium">
              ✓ Token saved. You can now use all YouTube operations.
            </div>
          )}
